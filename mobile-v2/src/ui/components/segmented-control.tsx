...
const styles = StyleSheet.create({ container: { minHeight: 44, flexDirection: 'row' }, item: { flex: 1, minHeight: 36, paddingHorizontal: 10, alignItems: 'center', justifyContent: 'center' }, scroll: { flex: 1 }, scrollContent: { flexDirection: 'row', gap: 4 }, scrollItem: { flex: 0, minWidth: 86 } });
