  ...
  async function requestCode() {
    ...
    try {
      ...
      if (err instanceof ApiError && err.status === 429) {
        ...
        setError(authErrorMessage(err, 'Unable to send a code.'));
      }
    }
