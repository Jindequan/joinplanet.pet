...
export default function TodayRoute() {
  ...
  const items = pets.flatMap((pet) => pet.items.map((item) => ({ item, petName: pet.pet_name, canAct: canActOnPet(pet.pet_id) })));
