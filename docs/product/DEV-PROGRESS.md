...
**2026-08-20（凌晨·管理入口显性化）**：founder 重提"account/family/pet 在哪管理、怎么切换"——上次用文字回答是错的，那是功能请求。已建成：••• 菜单 = 真管理菜单（Account/Family/Your pets）；Pet 页 Hero 下加横向宠物切换卡条（点选即切、激活高亮）+ "Your family" 家庭管理区（家庭名+成员+直达治理页）；Care circle 全局改称 Family（五语）。截图验证于 founder 本人账号。
