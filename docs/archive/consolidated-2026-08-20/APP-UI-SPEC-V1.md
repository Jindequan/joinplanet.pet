...
> **2026-08-19 修订（founder 决策）**：移除全局"＋"浮窗。理由：Timeline 页顶部已有快速记录卡片，全局浮窗在同一屏构成重复入口、在其他页是噪音；结构化记录（症状/体重/疫苗/就诊）的入口收敛为 Timeline 卡片上的内联 Record 按钮。三 Tab 结构不变；一级 IA 仍锁定。