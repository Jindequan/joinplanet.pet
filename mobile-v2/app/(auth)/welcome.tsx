...
const styles = StyleSheet.create({
  ...
  heroOrbLarge: { position: 'absolute', width: 260, height: 260, borderRadius: 130, borderWidth: 1, borderColor: 'rgba(255,255,255,0.2)', right: -72, top: -34 },
  heroOrbSmall: { position: 'absolute', width: 150, height: 150, borderRadius: 75, borderWidth: 1, borderColor: 'rgba(255,255,255,0.22)', right: 18, top: 22 },
