...
const styles = StyleSheet.create({
  ...
  careViewToggle: { flexDirection: 'row', gap: 3, padding: 3, borderRadius: 13 },
  careViewOption: { minHeight: 32, minWidth: 78, paddingHorizontal: 10, borderRadius: 10, alignItems: 'center', justifyContent: 'center' },
  alerts: { gap: 8 },
