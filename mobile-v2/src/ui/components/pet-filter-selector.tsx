...
const styles = StyleSheet.create({
  trigger: { minHeight: 44, maxWidth: 140, minWidth: 0, flexShrink: 1, paddingHorizontal: 11, borderWidth: 1, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 7 },
